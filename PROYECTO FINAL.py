...
dificil = {
    ...
    'INVERSIONDECONTROL': 125,
    'DEPENDENCIAINYECCION': 130
}
...
if __name__ == "__main__":
    ...
    for palabra in palabras_buscar:
        intentos = 0
        while True:
            if juego_terminado:  # Si el jugador elige salir, se interrumpe el ciclo principal
                break
        ...
        if juego_terminado:  # Si el jugador elige salir, también sale del ciclo principal
            break
